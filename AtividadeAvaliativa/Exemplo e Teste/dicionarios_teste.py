...
alfabeto = 'abcde'
for c in alfabeto:
    # Uma agenda cujas pessoas são as primeiras 5 letras.
    agenda1[c] = {'telefones': [1122233344]}

agenda2 = {}
vogais = 'aeiouy'
for c in vogais:
    # Uma agenda cujas pessoas são todas as vogais.
...
class TestPartOne(unittest.TestCase):
    ...
    def test_04_conta_letras(self):
        self.assertEqual(conta_letras('banana'), {'b': 1, 'a': 3, 'n': 2})
        self.assertEqual(conta_letras(''), {})
        self.assertEqual(conta_letras('a' * 5 + 'b' * 3 +
                                      'c' * 10 + 'a'), {'a': 6, 'b': 3, 'c': 10})
